...
PROFANITY_PATTERNS = [
    # ── 비속어 (profanity) ──────────────────────────────
    # 씨발 계열
    (r"씨[이\s]*발|시[이\s]*발|씨[이\s]*팔|시[이\s]*팔|씨[이\s]*벌|ㅅㅂ|ㅆㅂ|씨[0-9]*발|시[0-9]*발|싸[이]?발|쒸[이]?발|씌발|c발|씨bal|니미씨|니미시|시불|시블|씨부[랄럴렁]|시부[랄럴렁]", "씨발", "profanity"),
    # 개새끼 계열
    (r"개[새세][끼키]|개[새세]끼|개[새세]기|개색[끼키]|개[쌔쎄][끼키]|개[0-9]*새끼|ㄱㅅㄲ", "개새끼", "profanity"),
    # 병신 계열
    (r"병[\.]*신|byung[s]?in|ㅂㅅ|병[0-9]*신|빙신|벼ㅇ신|병딱|병1신", "병신", "profanity"),
    # 지랄 계열
